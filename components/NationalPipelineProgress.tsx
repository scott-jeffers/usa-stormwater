...
function statusClass(status: string): string {
  ...
  if (status === "running") return "text-amber-800";
  ...
  return (
    <div className="space-y-1.5">
      ...
      >
        ...
        {skippedShare > 0 && (
          <span className="bg-slate-300" style={{ width: `${skippedShare}%` }} />
        )}
        {pendingShare > 0 && (
          <span
      ...
      <ol className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {PROCESS_STEPS.map((step, i) => (
          <li key={step.id} className="text-sm">
            ...
            <p className="mt-1 leading-relaxed text-slate-600">{step.blurb}</p>
          </li>
        ))}
      </ol>
      ...
      {!status ? (
        ...
        <div className="space-y-4 border-t border-slate-100 pt-4">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
            ...
            <p>
              <span className="text-slate-500">Draft sections: </span>
            ...
            <p>
              <span className="text-slate-500">Editorial review: </span>
